...
### 1.5 AI类
#### 1.5.1 模型、训练
* civitai [链接](https://civitai.com/)
* liblibAI [链接](https://www.liblib.art/)
* huggingface [链接](https://huggingface.co/)
* modelscope [链接](https://www.modelscope.cn/)

#### 1.5.2 服务
* 火山引擎 [链接](https://www.volcengine.com/)
...
* 智星云 [链接](https://gpu.ai-galaxy.cn/)
### 5.2 低价CDN
* 比翼鸟数据 [链接](https://www.synidc.cn/)